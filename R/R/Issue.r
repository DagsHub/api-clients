...
Issue <- R6::R6Class(
  ...
  public = list(
    ...
    `updated_at` = NULL,
    `pull_request` = NULL,
    initialize = function(`id`, `number`, `user`, `title`, `body`, `labels`, `milestone`, `assignee`, `state`, `comments`, `created_at`, `updated_at`, `pull_request`){
      if (!missing(`id`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`title`)) {
        IssueObject[['title']] <- self$`title`
      }
      if (!is.null(self$`body`)) {
        IssueObject[['body']] <- self$`body`
      }
    ...
    fromJSON = function(IssueJson) {
      ...
      if (!is.null(IssueObject$`title`)) {
        self$`title` <- IssueObject$`title`
      }
      if (!is.null(IssueObject$`body`)) {
        self$`body` <- IssueObject$`body`
      }
      ...
      if (!is.null(IssueObject$`assignee`)) {
        assigneeObject <- ComponentsschemasUserYaml$new()
    ...
    fromJSONString = function(IssueJson) {
      ...
      ComponentsschemasUserYamlObject <- ComponentsschemasUserYaml$new()
      self$`assignee` <- ComponentsschemasUserYamlObject$fromJSON(jsonlite::toJSON(IssueObject$assignee, auto_unbox = TRUE))
      self$`state` <- IssueObject$`state`
      self$`comments` <- IssueObject$`comments`
      self$`created_at` <- IssueObject$`created_at`
      self$`updated_at` <- IssueObject$`updated_at`
