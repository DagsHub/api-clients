...
class StorageIntegrationsApi(
   ...
   * @return Files_1
   */
  def getBucketContent(owner: String, repo: String, protocol: String, bucket: String, &#x60;path&#x60;: String, includeSize: Option[Boolean] = Option(false), limit: Option[Integer] = Option(100), paging: Option[Boolean] = Option(false), fromToken: Option[String] = None): Option[Files_1] = {
    val await = Try(Await.result(getBucketContentAsync(owner, repo, protocol, bucket, &#x60;path&#x60;, includeSize, limit, paging, fromToken), Duration.Inf))
    await match {
   ...
   */
  def getBucketContentAsync(owner: String, repo: String, protocol: String, bucket: String, &#x60;path&#x60;: String, includeSize: Option[Boolean] = Option(false), limit: Option[Integer] = Option(100), paging: Option[Boolean] = Option(false), fromToken: Option[String] = None): Future[Files_1] = {
      helper.getBucketContent(owner, repo, protocol, bucket, &#x60;path&#x60;, includeSize, limit, paging, fromToken)
  }
...
class StorageIntegrationsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def getBucketContent(owner: String,
    ...
    paging: Option[Boolean] = Option(false),
    ...
    paging match {
      case Some(param) => queryParams += "paging" -> param.toString
      case _ => queryParams
    }
    fromToken match {
