...
class StorageIntegrationsApi(basePath: kotlin.String = "https://dagshub.com/api/v1") : ApiClient(basePath) {
    ...
    fun getBucketContent(owner: kotlin.String, repo: kotlin.String, protocol: kotlin.String, bucket: kotlin.String, path: kotlin.String, includeSize: kotlin.Boolean? = null, limit: kotlin.Int? = null, paging: kotlin.Boolean? = null, fromToken: kotlin.String? = null): Files1 {
        val localVariableQuery: MultiValueMap = mapOf("include_size" to listOf("$includeSize"), "limit" to listOf("$limit"), "paging" to listOf("$paging"), "from_token" to listOf("$fromToken"))
