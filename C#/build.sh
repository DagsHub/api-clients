...
${nuget_cmd} install src/dagshub-api/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/dagshub-api.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/dagshub-api.dll \
-recurse:'src/dagshub-api/*.cs' \
-doc:bin/dagshub-api.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/dagshub-api.dll was created successfully"
fi
