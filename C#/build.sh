...
${nuget_cmd} install src/dagshub_api/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/dagshub_api.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/dagshub_api.dll \
-recurse:'src/dagshub_api/*.cs' \
-doc:bin/dagshub_api.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/dagshub_api.dll was created successfully"
fi
