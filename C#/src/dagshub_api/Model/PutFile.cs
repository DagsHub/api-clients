...
namespace dagshub_api.Model
{
        ...
        public partial class PutFile :  IEquatable<PutFile>, IValidatableObject
    {
        ...
        /// <param name="commitChoice">commitChoice (required).</param>
        /// <param name="lastCommit">If omitted, **only new files** will be accepted.     Otherwise, the request is accepted only if **the tip of the branch is the same as &#x60;last_commit&#x60;** at the moment of processing the request.  This is done to prevent accidental conflicting changes. To get the latest commit you can use the [branches API](#operations-Branches-getBranch) .</param>
        /// <param name="newBranchName">newBranchName.</param>
        /// <param name="versioning">versioning (default to VersioningEnum.Auto).</param>
        /// <param name="files">This property can be sent multiple times to upload multiple files. (required).</param>
        public PutFile(string commitSummary = default(string), string commitMessage = default(string), CommitChoiceEnum commitChoice = default(CommitChoiceEnum), string lastCommit = default(string), string newBranchName = default(string), VersioningEnum? versioning = VersioningEnum.Auto, string files = default(string))
        {
            // to ensure "commitChoice" is required (not null)
            if (commitChoice == null)
            {
                throw new InvalidDataException("commitChoice is a required property for PutFile and cannot be null");
            }
            else
            {
            ...
            if (files == null)
            {
                throw new InvalidDataException("files is a required property for PutFile and cannot be null");
            }
            else
            {
                this.Files = files;
            ...
            // use default value if no "versioning" provided
            if (versioning == null)
            {
                this.Versioning = VersioningEnum.Auto;
            }
            else
            {
        ...
        /// </summary>
        /// <value>If omitted, **only new files** will be accepted.     Otherwise, the request is accepted only if **the tip of the branch is the same as &#x60;last_commit&#x60;** at the moment of processing the request.  This is done to prevent accidental conflicting changes. To get the latest commit you can use the [branches API](#operations-Branches-getBranch) </value>
        ...
        /// </summary>
        /// <value>This property can be sent multiple times to upload multiple files.</value>
