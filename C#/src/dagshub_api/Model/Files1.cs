...
namespace dagshub_api.Model
{
        ...
        public partial class Files1 :  IEquatable<Files1>, IValidatableObject
    {
        ...
        /// <param name="nextToken">Next token to continue pagination from.</param>
        public Files1(List<ComponentsschemasFileYaml> entries = default(List<ComponentsschemasFileYaml>), string nextToken = default(string))
        {
        ...
        public List<ComponentsschemasFileYaml> Entries { get; set; }

        /// <summary>
        /// Next token to continue pagination from
        /// </summary>
        /// <value>Next token to continue pagination from</value>
