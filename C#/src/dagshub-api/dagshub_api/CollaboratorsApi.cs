...
namespace dagshub-api.dagshub_api
{
    /// <summary>
        ...
        public interface ICollaboratorsApi : IApiAccessor
    {
        ...
        /// 
        /// </remarks>
        /// <exception cref="dagshub-api.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    {
        private dagshub-api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = new dagshub-api.Client.Configuration { BasePath = basePath };

            ExceptionFactory = dagshub-api.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        {
            this.Configuration = dagshub-api.Client.Configuration.Default;
        ...
        /// <returns></returns>
        public CollaboratorsApi(dagshub-api.Client.Configuration configuration = null)
        {
        ...
        public dagshub-api.Client.Configuration Configuration {get; set;}

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public dagshub-api.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
