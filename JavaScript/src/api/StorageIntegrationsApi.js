...
export class StorageIntegrationsApi {
    ...
    */
     ...
     * @param {Boolean} opts.paging Whether or not paging is enabled (default to <.>)
     * @param {String} opts.fromToken [Only if paging is enabled] token, from which to continue iteration
    ...
    getBucketContent(owner, repo, protocol, bucket, path, opts, callback) {
      ...
      let queryParams = {
        'include_size': opts['includeSize'],'limit': opts['limit'],'paging': opts['paging'],'from_token': opts['fromToken']
      };
      let headerParams = {
