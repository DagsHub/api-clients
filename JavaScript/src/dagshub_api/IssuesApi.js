...
export class IssuesApi {
    ...
    * @alias module:dagshub_api/IssuesApi
    * @class
    ...
    */
     ...
     * @callback moduledagshub_api/IssuesApi~createIssueCallback
     ...
     * @param {module:dagshub_api/IssuesApi~createIssueCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback moduledagshub_api/IssuesApi~editIssueCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Issue{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:dagshub_api/IssuesApi~editIssueCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
     ...
     * @callback moduledagshub_api/IssuesApi~getIssueCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Issue{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:dagshub_api/IssuesApi~getIssueCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
     ...
     * @callback moduledagshub_api/IssuesApi~listRepoIssuesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} owner owner of the repository
     * @param {String} repo name of the repository
     * @param {module:dagshub_api/IssuesApi~listRepoIssuesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
