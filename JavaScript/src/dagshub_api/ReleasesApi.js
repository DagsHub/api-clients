...
/**
* Releases service.
* @module dagshub_api/ReleasesApi
* @version 0.1.0
*/
export class ReleasesApi {
    ...
    * @alias module:dagshub_api/ReleasesApi
    * @class
    ...
    */
     ...
     * @callback moduledagshub_api/ReleasesApi~listReleasesCallback
     ...
     * @param {module:dagshub_api/ReleasesApi~listReleasesCallback} callback The callback function, accepting three arguments: error, data, response
     */
