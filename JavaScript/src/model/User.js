...
export class User {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('public_email'))
        obj.publicEmail = ApiClient.convertToType(data['public_email'], 'String');
...
/**
 * @member {String} publicEmail
 */
User.prototype.publicEmail = undefined;
