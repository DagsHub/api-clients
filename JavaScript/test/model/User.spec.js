...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('User', function() {
      ...
      it('should have the property publicEmail (base name: "public_email")', function() {
        // TODO: update the code to test the property publicEmail
        expect(instance).to.have.property('publicEmail');
        // expect(instance.publicEmail).to.be(expectedValueLiteral);
      });
