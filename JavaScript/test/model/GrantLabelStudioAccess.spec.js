...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GrantLabelStudioAccess', function() {
      beforeEach(function() {
        instance = new DagsHubApi.GrantLabelStudioAccess();
      });

      it('should create an instance of GrantLabelStudioAccess', function() {
        // TODO: update the code to test GrantLabelStudioAccess
        expect(instance).to.be.a(DagsHubApi.GrantLabelStudioAccess);
      });
