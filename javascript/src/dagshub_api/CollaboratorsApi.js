...
* @module dagshub_api/CollaboratorsApi
* @version 1.0.0
*/
export class CollaboratorsApi {
    ...
    * @alias module:dagshub_api/CollaboratorsApi
    * @class
    ...
    */
     ...
     * @callback moduledagshub_api/CollaboratorsApi~addCollaboratorCallback
     ...
     * @param {module:dagshub_api/CollaboratorsApi~addCollaboratorCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback moduledagshub_api/CollaboratorsApi~getCollaboratorsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} username A DagsHub username
     * @param {String} repo name of the repository
     * @param {module:dagshub_api/CollaboratorsApi~getCollaboratorsCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback moduledagshub_api/CollaboratorsApi~removeCollaboratorCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * Delete collaborator
     * @param {module:dagshub_api/CollaboratorsApi~removeCollaboratorCallback} callback The callback function, accepting three arguments: error, data, response
     */
