...
/**
* Webhooks service.
* @module dagshub_api/WebhooksApi
* @version 1.0.0
*/
export class WebhooksApi {
    ...
    * @alias module:dagshub_api/WebhooksApi
    * @class
    ...
    */
     ...
     * @callback moduledagshub_api/WebhooksApi~createHookCallback
     ...
     * @param {module:dagshub_api/WebhooksApi~createHookCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback moduledagshub_api/WebhooksApi~deleteHookCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} repo name of the repository
     * @param {Number} id 
     * @param {module:dagshub_api/WebhooksApi~deleteHookCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback moduledagshub_api/WebhooksApi~editHookCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:dagshub_api/WebhooksApi~editHookCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback moduledagshub_api/WebhooksApi~listHooksCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} owner owner of the repository
     * @param {String} repo name of the repository
     * @param {module:dagshub_api/WebhooksApi~listHooksCallback} callback The callback function, accepting three arguments: error, data, response
     */
