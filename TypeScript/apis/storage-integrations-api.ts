...
export const StorageIntegrationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {boolean} [paging] Whether or not paging is enabled
         * @param {string} [fromToken] [Only if paging is enabled] token, from which to continue iteration
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getBucketContent: async (owner: string, repo: string, protocol: string, bucket: string, path: string, includeSize?: boolean, limit?: number, paging?: boolean, fromToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const StorageIntegrationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getBucketContent(owner: string, repo: string, protocol: string, bucket: string, path: string, includeSize?: boolean, limit?: number, paging?: boolean, fromToken?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Files1>>> {
            const localVarAxiosArgs = await StorageIntegrationsApiAxiosParamCreator(configuration).getBucketContent(owner, repo, protocol, bucket, path, includeSize, limit, paging, fromToken, options);
...
export const StorageIntegrationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getBucketContent(owner: string, repo: string, protocol: string, bucket: string, path: string, includeSize?: boolean, limit?: number, paging?: boolean, fromToken?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Files1>> {
            return StorageIntegrationsApiFp(configuration).getBucketContent(owner, repo, protocol, bucket, path, includeSize, limit, paging, fromToken, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get file in the bucket
...
export class StorageIntegrationsApi extends BaseAPI {
     ...
     */
    public async getBucketContent(owner: string, repo: string, protocol: string, bucket: string, path: string, includeSize?: boolean, limit?: number, paging?: boolean, fromToken?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Files1>> {
        return StorageIntegrationsApiFp(this.configuration).getBucketContent(owner, repo, protocol, bucket, path, includeSize, limit, paging, fromToken, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Get file in the bucket
