...
public class CreateRepo {
   ...
   */
  @JsonAdapter(ProjectTemplateEnum.Adapter.class)
  public enum ProjectTemplateEnum {
    ...
    ProjectTemplateEnum(String value) {
      this.value = value;
    }
    ...
    public static ProjectTemplateEnum fromValue(String input) {
      for (ProjectTemplateEnum b : ProjectTemplateEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ProjectTemplateEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ProjectTemplateEnum enumeration) throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }

      @Override
      public ProjectTemplateEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return ProjectTemplateEnum.fromValue((String)(value));
      }
    }
  }  @SerializedName("project_template")
  private ProjectTemplateEnum projectTemplate = null;
  ...
  **/
  ...
  public CreateRepo projectTemplate(ProjectTemplateEnum projectTemplate) {
  ...
  **/
  @Schema(description = "Choose 'custom' to set .gitignore, license and readme, or 'none' for a completely empty repository. For other templates you may specify only the license. ")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, createRepo.name) &&
        ...
        Objects.equals(this.projectTemplate, createRepo.projectTemplate) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, _private, autoInit, projectTemplate, gitignores, license, readme);
  }
