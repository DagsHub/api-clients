...
public class ContentApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getContentCall(String owner, String repo, String branch, String path, Boolean includeSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/repos/{owner}/{repo}/content/{branch}/{path}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getContentValidateBeforeCall(String owner, String repo, String branch, String path, Boolean includeSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getContentCall(owner, repo, branch, path, includeSize, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Files getContent(String owner, String repo, String branch, String path, Boolean includeSize) throws ApiException {
        ApiResponse<Files> resp = getContentWithHttpInfo(owner, repo, branch, path, includeSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Files> getContentWithHttpInfo(String owner, String repo, String branch, String path, Boolean includeSize) throws ApiException {
        com.squareup.okhttp.Call call = getContentValidateBeforeCall(owner, repo, branch, path, includeSize, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getContentAsync(String owner, String repo, String branch, String path, Boolean includeSize, final ApiCallback<Files> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getContentValidateBeforeCall(owner, repo, branch, path, includeSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Files>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call uploadContentValidateBeforeCall(String owner, String repo, String branch, String path, String commitSummary, String commitMessage, String commitChoice, String lastCommit, String newBranchName, String versioning, String files, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
        ...
        // verify the required parameter 'path' is set
        if (path == null) {
            throw new ApiException("Missing the required parameter 'path' when calling uploadContent(Async)");
        }
        
        com.squareup.okhttp.Call call = uploadContentCall(owner, repo, branch, path, commitSummary, commitMessage, commitChoice, lastCommit, newBranchName, versioning, files, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void uploadContent(String owner, String repo, String branch, String path, String commitSummary, String commitMessage, String commitChoice, String lastCommit, String newBranchName, String versioning, String files) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> uploadContentWithHttpInfo(String owner, String repo, String branch, String path, String commitSummary, String commitMessage, String commitChoice, String lastCommit, String newBranchName, String versioning, String files) throws ApiException {
        com.squareup.okhttp.Call call = uploadContentValidateBeforeCall(owner, repo, branch, path, commitSummary, commitMessage, commitChoice, lastCommit, newBranchName, versioning, files, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call uploadContentAsync(String owner, String repo, String branch, String path, String commitSummary, String commitMessage, String commitChoice, String lastCommit, String newBranchName, String versioning, String files, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = uploadContentValidateBeforeCall(owner, repo, branch, path, commitSummary, commitMessage, commitChoice, lastCommit, newBranchName, versioning, files, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
