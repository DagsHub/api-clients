...
public class StorageIntegrationsApi {
     ...
     * @param paging Whether or not paging is enabled (optional, default to false)
     * @param fromToken [Only if paging is enabled] token, from which to continue iteration (optional)
    ...
    public com.squareup.okhttp.Call getBucketContentCall(String owner, String repo, String protocol, String bucket, String path, Boolean includeSize, Integer limit, Boolean paging, String fromToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (paging != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("paging", paging));
        if (fromToken != null)
    ...
    private com.squareup.okhttp.Call getBucketContentValidateBeforeCall(String owner, String repo, String protocol, String bucket, String path, Boolean includeSize, Integer limit, Boolean paging, String fromToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBucketContentCall(owner, repo, protocol, bucket, path, includeSize, limit, paging, fromToken, progressListener, progressRequestListener);
        return call;
     ...
     */
    public Files1 getBucketContent(String owner, String repo, String protocol, String bucket, String path, Boolean includeSize, Integer limit, Boolean paging, String fromToken) throws ApiException {
        ApiResponse<Files1> resp = getBucketContentWithHttpInfo(owner, repo, protocol, bucket, path, includeSize, limit, paging, fromToken);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Files1> getBucketContentWithHttpInfo(String owner, String repo, String protocol, String bucket, String path, Boolean includeSize, Integer limit, Boolean paging, String fromToken) throws ApiException {
        com.squareup.okhttp.Call call = getBucketContentValidateBeforeCall(owner, repo, protocol, bucket, path, includeSize, limit, paging, fromToken, null, null);
     ...
     */
    public com.squareup.okhttp.Call getBucketContentAsync(String owner, String repo, String protocol, String bucket, String path, Boolean includeSize, Integer limit, Boolean paging, String fromToken, final ApiCallback<Files1> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBucketContentValidateBeforeCall(owner, repo, protocol, bucket, path, includeSize, limit, paging, fromToken, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Files1>(){}.getType();
