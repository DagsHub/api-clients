...
class StorageIntegrationsApi(object):
    ...
    def get_bucket_content(self, owner, repo, protocol, bucket, path, **kwargs):  # noqa: E501
        ...
        :param bool paging: Whether or not paging is enabled
        :param str from_token: [Only if paging is enabled] token, from which to continue iteration
        :return: Files1
    ...
    def get_bucket_content_with_http_info(self, owner, repo, protocol, bucket, path, **kwargs):  # noqa: E501
        ...
        all_params = ['owner', 'repo', 'protocol', 'bucket', 'path', 'include_size', 'limit', 'paging', 'from_token']  # noqa: E501
        ...
        if 'paging' in params:
            query_params.append(('paging', params['paging']))  # noqa: E501
